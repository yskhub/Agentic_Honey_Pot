...
This repository contains a FastAPI backend for a judge‑ready honeypot. It provides message ingestion, rule-based detection, an automated conversational agent, audit logging, persistent callback and outgoing message queues, and admin management endpoints.
